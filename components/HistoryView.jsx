   ...
   return (
      <div className="p-4 md:p-8 lg:p-12 max-w-6xl mx-auto w-full">
         <div className="flex justify-between items-center mb-8">
            <BrutalistButton onClick={() => { resetGame(); navigate('/'); }} size="sm" variant="secondary">
                  ...
                  >
                     <div className="flex-1 w-full md:w-auto">
                        <div className="flex items-center gap-2 mb-2">
                           ...
                           <span className={`px-2 py-0.5 border-2 border-black font-bold text-xs uppercase ${entry.difficulty === 'Brutal' ? 'bg-brut-red text-white' : 'bg-gray-100'
                              }`}>
                              {entry.difficulty}
                           </span>
                        </div>
